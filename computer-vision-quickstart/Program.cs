       ...
       public static async Task<List<string>> GenerateListOfSecurityRecommendations(string text, string apiKey, string apiEndpoint)
        ...
        public static async Task<List<string>> GenerateListOfSecurityThreats(string text, string apiKey, string apiEndpoint)
        {
            ...
            string prompt =
                ...
                "As a Microsoft Azure security engineer specializing in threat model analysis and risk mitigation, you have been tasked with evaluating the security posture of various Azure services:\n" +
                $"{text}\n" +
                "Your objective is to identify service-specific security threats by leveraging Microsoft STRIDE threat modeling framework documentation and Microsoft docs. Explore the following resources: https://learn.microsoft.com/en-us/azure/security/fundamentals/best-practices-and-patterns, https://learn.microsoft.com/en-us/security/benchmark/azure/ and related documentation to find tailored security advice for each service and print your sources.\n";
